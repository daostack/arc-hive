...
async function main() {
  ...
  const appContract = Contracts.getFromLocal('App').at(appAddress);

//   appContract.getPastEvents('AllEvents', {
//     fromBlock: 0,
//     toBlock: 'latest'
...
// });
  ...
  console.log("provider",await appContract.methods.getProvider("creating-instances-from-solidity").call(txParams));
  console.log("getPackage",await appContract.methods.getPackage("creating-instances-from-solidity").call(txParams));
